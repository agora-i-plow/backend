...
Производительность нашего решения мы оценивали, подавая на вход алгоритму батчи разных размеров (при этом матчинг производился относительно всех предоставленных эталонов):
...
1. Думали над тем как использовать свойства товаров (props)

Придумали конкатенировать их с названием товара и искать по ним обоим. В итоге это сильно повлияло на скорость предсказания, зато мы добились повышения точность на 0.04, что является значительным приростом и увеличло точность нашей модели до ~0.93 результаты бенчмарков можно видеть ниже. 




![image](https://user-images.githubusercontent.com/53406289/185764517-6f0c6701-82ae-4060-b5ad-e9bf0d7688d7.png)

4. (WIP) Разделили и добавили по частям именования со спецсимволами. (Было "сплит-система", стало "сплит-система сплит система")
5. (WIP) Думаем над тем как использовать свойства товаров.
